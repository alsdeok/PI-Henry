...
const { Pokemon, Typepoke } = sequelize.models;
...
Pokemon.belongsToMany(Typepoke, {through: "Poke", timestamps: false})
Typepoke.belongsToMany(Pokemon, {through: "Poke", timestamps: false})
module.exports = {
